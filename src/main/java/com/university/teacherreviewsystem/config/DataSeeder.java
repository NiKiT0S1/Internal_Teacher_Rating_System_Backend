 ...
 * Заполняет базу данных начальными данными (пользователи, преподаватели, критерии)
 * Проверяет существование данных перед созданием (избегает дублирования)
 */
...
public class DataSeeder {
    ...
    CommandLineRunner seedDatabase(UserRepository userRepo,
                                   ...
                                   CriteriaRepository criteriaRepo, PasswordEncoder passwordEncoder) {
        return args -> {
